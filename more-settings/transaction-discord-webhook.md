...
| :hourglass: Pending Order                  | When customer purchase manual batch type orders, first it will mark as pending, after admin fulfil it will mark as complete | Orange     | #ff7538        |
...
| :no\_entry: Subscription Renewal Failed    | Subscription renewal failed                                                                                                 | Salmon     | #ff6f61        |
| :pencil: Data Update                       | When admin add or remove residential data                                                                                   | Yellow     | #eeee44        |

These color codes help users and support teams quickly recognize the nature of a transaction at a glance within Discord.
