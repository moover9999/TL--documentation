...
| SN\_LA\_TICKETS (**Subnets**)                         | Los Angeles, USA   | AT\&T, Windstream, RCN, Wave, Spectrum/Charter, Frontier _(coming soon)_         | High-demand ticketing platforms (TM, AXS, SG)                                        |
...
| ISP\_UK\_RETAILPLUS                                   | London, UK         | Virgin Media, British Telecom, Dtag, Orange _(**moving to just BT and Virgin**)_ | Pokemon Centre, Popmart, Target and retail sites (**DOES NOT WORK FOR EVENT SITES**) |
...
| <p>SN_UK_RETAILPLUS<br>(<strong>Subnets</strong>)</p> | London, UK         | Virgin Media, British Telecom, Dtag, Orange _(**moving to just BT and Virgin**)_ | Retail sites such as Pokemon Centre, Popmart, Target                                 |
